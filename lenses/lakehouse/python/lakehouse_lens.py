...
# Make bindings/python/core, bindings/python/sdk, and physical_structures importable
...
class LakehouseLens(PondLens):
    ...
    def __init__(self, kernel: PondMinimal):
        ...
        if _HAVE_POND_STORAGE:
            ...
            raise ImportError("PondStorage not available — install the bindings/python/sdk package")
