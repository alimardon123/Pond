/*
 * Pond Rust Core — C ABI Header
 *
 * This header defines the C ABI for Pond's Rust core library.
 ...
 *
 * Usage:
 *   1. Link against libpond_rust.a (static) or libpond_rust.so (dynamic)
 *   2. #include "pond_rust.h"
 *   3. Call pond_pnd2_decode() to decode, pond_result_* to access, pond_result_free() to cleanup
