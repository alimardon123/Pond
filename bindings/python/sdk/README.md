...
- `bindings/python/core/` (the kernel — 3 primitives, ~199 LOC)
- Python stdlib only (no external packages)

## Architecture

```
bindings/python/core (kernel: Write, Read, Ref — FROZEN, ~199 LOC)
    ↓
bindings/python/sdk (base_lens, prolly_tree, collection_metadata, extensions/)
    ↓
