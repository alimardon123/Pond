...
This View tests whether multi-tenancy can be solved at the View level
...
class NaiveTenantView:
    ...
    before calling kernel.reference(). But: the View CANNOT prevent
...
class CapabilityTenantView:
    ...
    The token is generated by the View and stored client-side.
...
def exp_capability_tokens():
    ...
    print(f"  by a View-level namespace store that doesn't expose list_names().")
    print()
...
def main():
    ...
    print("  need isolation? If View-level works, the kernel is sufficient.")
    print("=" * 76)
    ...
    print("     Two View-level strategies work:")
    ...
    print("  Multi-tenancy is solved at the View/infrastructure level:")
    ...
    print()
    print("  The kernel survived its second truly hostile View. Multi-tenancy works.")
