...
def benchmark_unified_vs_old():
    ...
    old_rw_manifest = kernel.resolve("collections/old_rw/manifest") is not None
    ...
    old_enc_manifest = kernel.resolve("collections/old_enc/manifest") is not None
    ...
    new_manifest = kernel.resolve("collections/unified/manifest") is not None
