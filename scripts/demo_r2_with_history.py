...
history["users_v1"] = kernel.resolve("collections/users/manifest")
...
history["users_v2"] = kernel.resolve("collections/users/manifest")
...
history["users_v3"] = kernel.resolve("collections/users/manifest")
...
history["orders_v1"] = kernel.resolve("collections/orders/manifest")
