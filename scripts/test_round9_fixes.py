...
def test_time_travel_no_mutation():
    ...
    manifest_after = kernel.resolve("collections/test/manifest")
...
def test_branch_read_no_mutation():
    ...
    # Save main manifest
    main_manifest = kernel.resolve("collections/users/manifest")
    ...
    main_after_branch = kernel.resolve("collections/users/manifest")
    ...
    main_after_read = kernel.resolve("collections/users/manifest")
