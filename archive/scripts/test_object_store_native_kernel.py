...
def test_basic_kernel_ops():
    ...
    kernel.reference("collections/users/_branches/main/commit", h)
    ...
    resolved = kernel.resolve("collections/users/_branches/main/commit")
    assert resolved == h
    ...
    read_data = kernel.read("collections/users/_branches/main/commit")
